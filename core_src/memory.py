...
def _vector_search(query: str, memory_dir: Path = None, limit: int = 20) -> list:
    """
    向量检索(v1.6.0 新增)
...
def main():
    ...
    if True:
        ...
        parser_vector_build.add_argument("--provider", choices=["openai", "zhipuai", "huggingface", "local"], help="嵌入提供者")
